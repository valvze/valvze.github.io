...
<section>
	<div class="inner">
		...
		<ul class="actions">
			<li><a href="posts/codingwalle.html" class="button next">Get Started</a></li>
		</ul>
	</div>
</section>
...
<section id="two" class="spotlights">
	<section>
		<a href="posts/shad.html" class="image">
			<img src="{% link assets/images/shad-logo.png %}" alt="" data-position="center center" />
		</a>
		<div class="content">
			<div class="inner">
				<header class="major">
				...
				<ul class="actions">
					<li><a href="posts/shad.html" class="button">Learn more</a></li>
				</ul>
			</div>
		</div>
	</section>
